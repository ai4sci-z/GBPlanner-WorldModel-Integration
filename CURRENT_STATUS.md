...
> **v2 批跑已定档(6 run,冻结口径):v5 未提升统计**(达标 17% vs 首批 50%,全绿 0/6;A类主导+新增 C类
> latch-probe 时序错配);合并 12 run 达标 33%、全绿 1/12,**仍显著优于基线 0/6,公平对比主结论不变**。
> 当前施工点 = **①probe 采样时刻源码查证(C类确定解)②kp0.35 对照批 → GUI 三演示 → PR 统一定稿**。

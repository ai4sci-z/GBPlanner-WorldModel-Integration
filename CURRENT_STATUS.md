...
**当前 = R003-S2-FIX(负责人 2026-07-16 有条件放行;非第二阶段验收通过)**:范围只限管理主仓
...
| 门 | 内容 | 状态 |
|---|---|---|
| 一 | 仓库和文档治理 | **S2-FIX 施工中**:清单闭包协议见 `governance/README.md` §1(数值以三份 manifest 头部与收口报告为准,本表不复制易过期计数);claim manifest 已建;第三方 LOCKED=0(缺口清单 §2);基准 tag/分支职责/依赖清单未完成 |

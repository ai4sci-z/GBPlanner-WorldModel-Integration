...
class MapManagerVoxblox : MapManager {
 public:
  // M3 signature adaptation (task book §7-M3): the ROS2 voxblox servers take
  // rclcpp::Node*; the shell owns the node and passes it through here.
  explicit MapManagerVoxblox(rclcpp::Node* node_ptr);

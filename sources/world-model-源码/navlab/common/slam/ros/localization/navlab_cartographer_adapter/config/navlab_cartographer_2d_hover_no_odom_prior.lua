...
-- Phase 41 ablation profile.
--
-- This is intentionally a copy of navlab_cartographer_2d_hover.lua with only
-- the odometry prior disabled. Do not tune scan matching here; the purpose is
-- to isolate whether scan-reference odometry prior injection is the source of
-- hover_hold drift.

...
| 6 | 对比·GBPlanner vs frontier_lite 量化对照 | 🔵 **首批 6 样本定档(07-07 下午)** | gate 达标率 **50% vs 基线 40%**(且我方 accepted=真实运动到达,基线纯时间驱动);全绿 1/6(runA);path 方差 0.30 vs 基线跨 3.4m;失败分类 A类探索质量/B类探针波动;⚠️基线跑于 EKF 修复前,严格结论需基线重跑。stage5c_summary_evidence.txt |

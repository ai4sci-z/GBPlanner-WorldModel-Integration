...
| WP | 任务 | 依赖 | 验收门 | 状态 |
|---|---|---|---|---|
| **WP303** | monitor 生命周期实现:launcher + task record + 三轴状态(producer_outcome/evidence_status/cleanup_status)+ ≥20 fixture;只跑 fixture 不跑真实仿真 | P0 收口 | 正式入口 run_batch.sh e2e dry-run + test_wait_batch 54/54 + test_batch_common 12/12 + test_final_rc 13/13,残留=0 | 🟡 **实现停点:正式入口 dry-run 通过,真实仿真未做** |
